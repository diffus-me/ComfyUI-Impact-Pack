...
def img2img_segs(context, image, model, clip, vae, seed, steps, cfg, sampler_name, scheduler,
    ...
    # ksampler
    refined_latent = impact_sampling.ksampler_wrapper(context, model, seed, steps, cfg, sampler_name, scheduler, positive, negative, refined_latent, denoise, scheduler_func=scheduler_func_opt)
